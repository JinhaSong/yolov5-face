...
from utils.general import check_img_size, non_max_suppression_face, xyxy2xywh, scale_coords


class YOLOv5Face(Detection):
    ...
    def detect(self, image):
        ...
        pred = non_max_suppression_face(pred, self.conf_thresh, self.iou_thresh)[0]
